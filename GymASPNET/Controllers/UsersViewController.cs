...
namespace GymASPNET.Controllers
{
    ...
    {
        private GYMEntitiesGlobal db = new GYMEntitiesGlobal();
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,Password,LastLogin")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,LastLogin")] User user)
        {
            if (ModelState.IsValid)
            {
